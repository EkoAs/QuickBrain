...
// Mode 5: Middle Value (Mixed Operations) Game Logic
...
// Generate MIXED MIDDLE VALUE question
function generateQuestion() {
    ...
    // The missing middle value (the correct answer) is strictly between 1 and 10
    num2 = randomInt(1, 10);
    ...
    if (operator === '+') {
        ...
        // To prevent negative results, num1 must be greater than or equal to num2
        num1 = randomInt(num2, 10); 
        result = num1 - num2;
        questionText = `${num1} - ? = ${result}`;
    } else if (operator === '×') {
        num1 = randomInt(1, 10);
        ...
        // To ensure clean division without decimals, calculate the dividend (num1)
    ...
    // Generate 3 wrong answers (decoys) strictly between 1 and 10
    const wrongAnswers = [];
    while (wrongAnswers.length < 3) {
        let wrong = randomInt(1, 10);
        
        // Ensure no duplicates and not equal to the correct answer
